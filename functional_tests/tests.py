...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def wait_check_for_row_in_list_table(self, row_text):
    ...
    def test_layout_and_styling(self):
        ...
        self.wait_check_for_row_in_list_table("1: testing")
        inputbox = self.browser.find_element(By.ID, "id_new_item")
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        inputbox.send_keys(Keys.ENTER)
        time.sleep(1)
        self.wait_check_for_row_in_list_table("1: Buy peacock feathers")
        ...
        self.wait_check_for_row_in_list_table("1: Buy peacock feathers")
        self.wait_check_for_row_in_list_table("2: Use peacock feathers to make a fly")
    ...
    def test_multiple_users_can_start_lists_at_diferent_urls(self):
        ...
        inputbox.send_keys(Keys.ENTER)
        self.wait_check_for_row_in_list_table("1: Buy milk")
